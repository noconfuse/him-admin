    ...
    <div class="app-container">
        ...
        <div class="table-list">
            ...
            <el-table ref="multipleTable" v-loading="loading" :data="tableData" border style="width: 100%" row-key="uuid" :default-expand-all="false">
                <el-table-column prop="linkUrl" label="背景图片" align="left" width="120">
                ...
                <el-table-column prop="imageIntroduce" label="介绍" align="left" min-width="200" />
                <el-table-column prop="imageIntroduceEn" label="英文介绍" align="left" min-width="200" />
    ...
    methods: {
        ...
        handleDel (row, index) {
            this.$syncConfirm({
                ...
                confirmFn: async () => {
                    return api.deletePicList(row.uuid);
                },
