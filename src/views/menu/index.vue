        ...
        <Dialog :dialog="dialog" @confirm="handleConfirm">
            <el-form :ref="dialog.ref" :model="dialog.form" :rules="dialog.rules" label-width="100px">
                <el-form-item label="中文名称" prop="menuName">
                    <el-input v-model="dialog.form.menuName" placeholder="请输入中文名称" maxlength="100" />
                </el-form-item>
                <el-form-item label="英文名称" prop="menuNameEn">
                    <el-input v-model="dialog.form.menuNameEn" placeholder="请输入英文名称" maxlength="100" />
                </el-form-item>
                <el-form-item label="跳转地址" prop="linkUrl">
                    <el-input v-model="dialog.form.linkUrl" placeholder="请输入跳转地址" maxlength="100" />
                </el-form-item>
            </el-form>
        </Dialog>
    </div>
