                    ...
                    <el-row :gutter="20" type="flex">
                        <el-col :xs="24" :sm="12">
                            <el-form-item label="中文名称" prop="menuName">
                                <el-input v-model="form.menuName" placeholder="请输入中文名称" maxlength="100" />
                            </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="12">
                            <el-form-item label="英文名称" prop="menuNameEn">
                                <el-input v-model="form.menuNameEn" placeholder="请输入英文名称" maxlength="100" />
                            </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="12">
                            <el-form-item label="跳转地址" prop="linkUrl">
                                <el-input v-model="form.linkUrl" placeholder="请输入跳转地址" maxlength="100" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                </div>
